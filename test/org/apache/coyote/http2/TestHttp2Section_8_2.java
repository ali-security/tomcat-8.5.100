...
public class TestHttp2Section_8_2 extends Http2TestBase {
    ...
    public static Collection<Object[]> parameters() {
        ...
        parameterSets.add(new Object[] { "x-test", "x-value", Boolean.TRUE });
        ...
        for (char c = 0; c < 256; c++) {
            ...
            parameterSets.add(new Object[] { "x-" + c + "t", "x-value", Boolean.valueOf(valid) });
            parameterSets.add(new Object[] { c + "x-t", "x-value", Boolean.valueOf(valid) });
            parameterSets.add(new Object[] { "x-t" + c, "x-value", Boolean.valueOf(valid) });
            // Huffman field names
            parameterSets.add(new Object[] { "x-te" + c + "st", "x-value", Boolean.valueOf(valid) });
            parameterSets.add(new Object[] { c + "x-test", "x-value", Boolean.valueOf(valid) });
            parameterSets.add(new Object[] { "x-test" + c, "x-value", Boolean.valueOf(valid) });

            // HTTP/2 field values have same criteria as HTTP/1.1
            // Non-Huffman field values
            parameterSets.add(new Object[] { "x-test", "x-" + c + "v",
                    Boolean.valueOf(HttpParser.isFieldContent(c)) });
            parameterSets.add(new Object[] { "x-test", c + "x-v",
                    Boolean.valueOf(HttpParser.isFieldVChar(c)) });
            parameterSets.add(new Object[] { "x-test", "x-v" + c,
                    Boolean.valueOf(HttpParser.isFieldVChar(c)) });
            parameterSets.add(new Object[] { "x-test", "" + c,
                    Boolean.valueOf(HttpParser.isFieldVChar(c)) });
            // Huffman field values
            parameterSets.add(new Object[] { "x-test", "x-va" + c + "lue",
                    Boolean.valueOf(HttpParser.isFieldContent(c)) });
            parameterSets.add(new Object[] { "x-test", c + "x-value",
                    Boolean.valueOf(HttpParser.isFieldVChar(c)) });
            parameterSets.add(new Object[] { "x-test", "x-value" + c,
                    Boolean.valueOf(HttpParser.isFieldVChar(c)) });
        }
