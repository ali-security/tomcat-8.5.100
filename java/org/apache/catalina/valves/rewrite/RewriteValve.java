        ...
        try {
            ...
            if (rewritten) {
                if (!done) {
                    ...
                    // Normalize expects decoded input, so decode first
                    String urlStringDecoded = URLDecoder.decode(urlStringRewriteEncoded, uriCharset.name());
                    ...
                    else {  // equivalent to if (queryStringRewriteEncoded != null)
